...
const Socios = (() => {
  ...
  const TIPOS = { aportacion: ['Aportación', 'text-ok'], retiro: ['Retiro', 'text-danger'], gasto_personal: ['Gasto personal', 'text-danger'], anticipo_utilidad: ['Honorarios de obra', 'text-danger'], utilidad_asignada: ['Utilidad asignada', 'text-ok'], utilidad_pagada: ['Utilidad pagada', 'text-danger'], ajuste: ['Ajuste', ''] };
  const SIGNO = { aportacion: 1, retiro: -1, gasto_personal: -1, anticipo_utilidad: -1, utilidad_asignada: 1, utilidad_pagada: -1, ajuste: 1 };
  ...
  function totalesSocio(id, desde, hasta) {
    const t = { aportacion: 0, retiro: 0, gasto_personal: 0, anticipo_utilidad: 0, utilidad_asignada: 0, utilidad_pagada: 0, ajuste: 0 };
